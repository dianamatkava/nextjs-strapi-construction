      ...
      <div className="w-full h-14 justify-start items-center gap-4 inline-flex overflow-hidden">
        <div className="w-full h-fit justify-start items-center gap-6 inline-flex animate-marquee">
          <div data-svg-wrapper>
            <AllstateLogo height={"85"} width={"110px"} />
          </div>
          <div data-svg-wrapper className={"mt-[23px]"}>
            <BerkshireLogo height={"45"} width={"100px"} />
          </div>
          <div data-svg-wrapper>
            <ChubbLogo height={45} width={"100px"} />
          </div>
          <div data-svg-wrapper>
            <LibertyLogo height={85} width={"130px"} />
          </div>
          <div data-svg-wrapper>
            <ProgressiveLogo height={45} width={"100px"} />
          </div>
          <div data-svg-wrapper>
            <USAALogo height={35} width={"40px"} />
          </div>
          <div data-svg-wrapper>
            <TravelersLogo height={45} width={"120px"} />
          </div>
          <div data-svg-wrapper>
            <AmericanFamilyLogo height={45} width={"100px"} />
          </div>
          <div data-svg-wrapper>
            <AIGLogo height={35} width={"60px"} />
          </div>
          <div data-svg-wrapper>
            <NationwideLogo height={85} width={"130px"} />
          </div>
          <div data-svg-wrapper>
            <FarmersInsuranceLogo height={45} width={"100px"} />
          </div>
