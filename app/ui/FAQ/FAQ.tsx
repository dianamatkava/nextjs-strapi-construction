...
const data = [
  ...
  {
    id: 3,
    question: "How long does the water damage restoration take?",
    answer:
  ...
  {
    id: 4,
    question: "Is water damage covered by my insurance?",
    answer:
  ...
  {
    id: 5,
    question: "Will there be mold after water damage?",
    answer:
...
export default function FAQ() {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-start gap-5 py-8">
      <div className="w-full flex flex-col justify-between items-start sm:items-center gap-8 sm:gap-16 sm:inline-flex sm:flex-row">
        <div
          className={
        ...
        <div className="sm:w-3/5 h-fit w-full sm:max-w-[700px] flex-col justify-center items-center gap-2.5 font-['Plus Jakarta Sans'] cursor-pointer">
          {data.map((item, index) => {
            return (
              <FAQQuestion
                key={item.id}
