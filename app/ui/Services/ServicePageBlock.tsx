...
export default function ServicePageBlock () {
  return (
    <div className="w-full h-fit flex-col justify-start items-center gap-5 inline-flex">
      <div className="w-full flex-col justify-start items-center flex">
        <HeaderH1 title={'1: Full-Service Water Restoration'}/>
        <div
      ...
      <div className="self-stretch justify-between items-center inline-flex gap-8">
        <ImageContainer src={"/Contract.jpg"} alt={"/Contract.jpg"} className={"hidden w-2/5 sm:block h-[300px]"}/>
        <div className="w-3/5 flex flex-col text-black text-sm font-normal font-['Plus Jakarta Sans'] gap-3">
