...
export default function StepByStepGuideItem({
  title,
  description,
  number,
  isActive = false,
  ...
  return (
    <div className="w-full lg:max-w-[250px] lg:min-w-[450px] h-fit p-5 bg-white rounded-xl shadow-[2px_4px_8px_0px_rgba(0,0,0,0.05)] flex-col justify-start items-start gap-2.5 inline-flex">
      <div className="flex-col justify-start items-start gap-2 flex">
        <div className="flex-row sm:flex-col justify-center items-start gap-3 flex">
          ...
          />
          <div className="pt-0.5 self-stretch text-black text-lg font-medium font-['Plus Jakarta Sans']">
            {title}
          </div>
        </div>
