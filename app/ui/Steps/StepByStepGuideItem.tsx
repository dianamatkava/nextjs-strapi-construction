...
export default function StepByStepGuideItem ({title, description, number, isActive=false}: {title: string, description: string, number, isActive: boolean}) {
  return (
    <div
      className="w-full min-w-[250px] h-fit p-5 bg-white rounded-xl shadow-[2px_4px_8px_0px_rgba(0,0,0,0.05)] flex-col justify-start items-start gap-2.5 inline-flex">
